...
public class list_sending_orders_gui extends JFrame {

    private Distributor distributor;

    public list_sending_orders_gui() {
        super("Sending Orders List");
        ...
        addLabelAndInput(panel, issnLabel, issnTextField);
        ...
        listele_btn.addActionListener(e -> {
            ...
            String paragraph = distributor.listSendingOrders(issnTextField.getText(), Integer.parseInt(ayTextField.getText()), Integer.parseInt(yilTextField.getText()));
